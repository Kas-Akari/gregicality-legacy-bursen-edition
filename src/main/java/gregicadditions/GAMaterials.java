...
public class GAMaterials implements IMaterialHandler {
    ...
    public static final IngotMaterial GoldAlloy = new IngotMaterial(828, "gold_alloy", 0xBBA52B, MaterialIconSet.SHINY, 2, of(new MaterialStack(Copper, 3), new MaterialStack(Gold, 2), new MaterialStack(RareEarth, 1)), DISABLE_DECOMPOSITION);
    ...
    public static final SimpleDustMaterial GoldLeach = new SimpleDustMaterial("gold_leach", 0xBBA52B, (short) 904, MaterialIconSet.ROUGH, "Cu3Au2(OH)3?");
